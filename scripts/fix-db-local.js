...
async function main() {
  ...
  try {
    ...
    console.log("1. Ajout colonne headlines...");
    ...
    console.log("2. Ajout colonne tags...");
    await prisma.$executeRawUnsafe(`
    ...
    console.log("3. Vérification Enum InterestCategory...");
    try {
      await prisma.$executeRawUnsafe(`
        DO $$ BEGIN
    ...
    console.log("4. Ajout colonne interests sur users...");
    await prisma.$executeRawUnsafe(`
    ...
    console.log("5. Ajout colonne region sur users...");
    await prisma.$executeRawUnsafe(`
    ...
    console.log("6. Création Enums Publicité...");
    try {
      await prisma.$executeRawUnsafe(`
        DO $$ BEGIN
    ...
    console.log("7. Mise à jour enterprise_accounts...");
    await prisma.$executeRawUnsafe(`
    ...
    console.log("8. Création tables Plans & Transactions...");
    try {
      await prisma.$executeRawUnsafe(`
        DO $$ BEGIN
    ...
    console.log("9. Création tables Publicité...");
    await prisma.$executeRawUnsafe(`
    ...
    console.log("10. Ajout colonne planId sur subscriptions...");
    await prisma.$executeRawUnsafe(`
    ...
    console.log("11. Création table reading_sessions...");
    await prisma.$executeRawUnsafe(`
    ...
    console.log("12. Création table ReadingProgress...");
    await prisma.$executeRawUnsafe(`
    ...
    console.log("13. Mise à jour Enum SubscriptionType...");
    try {
    ...
    console.log("14. Nettoyage colonnes obsolètes...");
    try {
