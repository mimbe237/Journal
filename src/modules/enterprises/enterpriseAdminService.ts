...
VALUES (gen_random_uuid(), 'manual', NOW(), '20251216120000_add_enterprise_admin_system', NULL, NULL, NOW(), 1);getEnterpriseStats(enterpriseAccountId: string): Promise<EnterpriseStats> {
